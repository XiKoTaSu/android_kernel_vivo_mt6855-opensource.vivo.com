...
static const struct proc_ops proc_event_track_ops = {
	.proc_open = event_track_open,
	.proc_release = event_track_release,
	.proc_read = event_track_read,
	.proc_write = event_track_write,
