...
#define IS_F2FS_GC_THREAD() (strncmp("f2fs_gc", current->comm, 7) == 0)
#endif
...
struct f2fs_sb_info {
	...
	struct f2fs_gc_control_info gc_control_info;
	struct delayed_work gc_temperary_work;
#endif
