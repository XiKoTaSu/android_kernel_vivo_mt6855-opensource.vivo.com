...
/*add by vivo audio yanghen for tfa9894 cail start*/
#if IS_ENABLED(CONFIG_SND_SOC_TFA9894)
#include <linux/version.h>
#include "../../vivo/tfa9894/inc/tfa98xx.h"
static struct tfa98xx_calib *tfa_calibration;
extern unsigned int is_atboot;
#endif
/*add by vivo audio yanghen for tfa9894 cail end*/
/*
...
static const char *const mt6789_spk_type_str[] = {MTK_SPK_NOT_SMARTPA_STR,
						  ...
						  /*add by vivo audio yanghen for spk type*/
						  MTK_SPK_GOODIX_TFA9874_STR,
						  MTK_SPK_RICHTEK_RT5512_STR,
						  MTK_SPK_AW_AW88XXX_STR,
						  MTK_SPK_GOODIX_TFA9894_STR
						  };
...
/*add by vivo audio for i2s clock ctrl start*/
...
/*add by vivo audio for i2s clock ctrl end*/
...
/*add by vivo audio yanghen for i2s clock ctrl start*/
static void mtk_i2s3_config_for_calibration(struct mtk_base_afe *afe, bool enable)
{
	unsigned int i2s_con = 0;
  	...
  	if (enable) {
  		...
  		/* Config I2S3 gpio */
  		mt6789_afe_gpio_request(afe, true, MT6789_DAI_I2S_3, 0);
  		...
  		/* Config I2S3 gpio */
  		mt6789_afe_gpio_request(afe, false, MT6789_DAI_I2S_3, 0);
  		/* Disable APLL2 clock */
...
/*add by vivo audio yanghen for i2s clock ctrl end*/
...
static const struct snd_kcontrol_new mt6789_mt6366_controls[] = {
	...
	/*add by vivo audio  for i2s clock ctrl*/ 
...
/*add by vivo audio yanghen for tfa9894 cail start*/
	...
	if(!tfa_calibration)
	{
		pr_info("%s,tfa_calibration is null",__func__);
	}
	if (tfa_calibration && (0 == is_atboot)) {
		mtk_i2s3_config_for_calibration(afe_base, true);
		if (ret) {
			dev_err(&pdev->dev, "sound card is not initialized , smartpa i2s clock failed\n");
