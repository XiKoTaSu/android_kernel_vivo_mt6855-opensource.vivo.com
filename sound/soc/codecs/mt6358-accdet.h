...
/*add by vivo audio */
#define ACCDET_AT_IOCTL_GET_TYPE  _IOR(ACCDET_IOC_MAGIC, 0x03, int)
#define ACCDET_AT_IOCTL_MOS_TEST  _IOR(ACCDET_IOC_MAGIC, 0x04, int)
#define ACCDET_AT_IOCTL_HPH_REMOVE  _IOR(ACCDET_IOC_MAGIC, 0x05, int)
#define ACCDET_AT_IOCTL_ATMODE  _IOR(ACCDET_IOC_MAGIC, 0x06, int)
#define ACCDET_AT_IOCTL_NOTIFY_SMARTPA  _IOR(ACCDET_IOC_MAGIC, 0x07, int)
#define ACCDET_AT_IOCTL_GET_USBC_STATUS _IOR(ACCDET_IOC_MAGIC, 0x08, int)
#define ACCDET_AT_IOCTL_GET_USBC_MG_STATUS _IOR(ACCDET_IOC_MAGIC, 0x09, int)
#define ACCDET_AT_IOCTL_GET_MIC_ADC_VOLTAGE _IOR(ACCDET_IOC_MAGIC, 0x0A, int)
