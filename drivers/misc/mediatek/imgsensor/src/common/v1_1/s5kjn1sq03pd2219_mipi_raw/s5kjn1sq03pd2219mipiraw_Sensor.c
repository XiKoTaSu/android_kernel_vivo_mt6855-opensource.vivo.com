...
#include "s5kjn1sq03pd2219mipiraw_Sensor.h"
...
struct IMGSENSOR_SENSOR_TABLEINFO s5kjn1sq03pd2219_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA0,
        .OTP_size = 0x3B50,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03PD2219_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{8160, 6144,    0,  776, 8160, 4592, 4080, 2296, 0, 0, 4080, 2296, 0, 0, 4080, 2296}, /*custom4*/
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =  //4080X3072
{
	...
	.i4BlockNumY = 382,
	.iMirrorFlip = 3,
	.i4Crop = { {0,0}, {0,0}, {0, 382}, {0, 0}, {0, 0}, {408, 312}, {120, 450}, {0, 0}, {0, 382}, {120, 450}}, //4080, 2296
};
#endif
...
static kal_uint16 addr_data_pair_preview[] = { //4080x3060
	...
	0x0D04, 0x0102,
	0x6226, 0x0000,
	0xB13C, 0x0800,		//mipi 1.1.1
	0x0810, 0x0014,		//mipi 1.3.13
};
...
static kal_uint16 addr_data_pair_capture[] = {  //4080x3060
	...
	0x0D04, 0x0102,
	0x6226, 0x0000,
	0xB13C, 0x0000,		//mipi 1.1.1
	0x0810, 0x0000,		//mipi 1.3.13
};
...
static kal_uint16 addr_data_pair_custom1[] = {  //3624*2448
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 addr_data_pair_custom2[] = {  //3840x2160 60fps
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 addr_data_pair_custom3[] = {   //3840x2160 30fps
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 addr_data_pair_custom4[] = {  //4080x2296 30fps
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000);
			...
			pr_err("read out sensor version %d \n",sensor_version);
			...
			if (( *sensor_id == imgsensor_info.sensor_id) || ( *sensor_id == 0xe138) || ( *sensor_id == 0x38ef)) {
				pr_err("i2c write id: 0x%x, sensor id: 0x%x, isOtpSetting = %d\n", imgsensor.i2c_write_id,*sensor_id,isOtpSetting);
				return ERROR_NONE;
			}
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		case MSDK_SCENARIO_ID_CUSTOM3:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; /* 3840x2160 */
			break;
		case MSDK_SCENARIO_ID_CUSTOM4:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; /* 4080*2296 */
			break;
		case MSDK_SCENARIO_ID_CUSTOM5:
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		switch (*feature_data) {
			case 0:
				memcpy((MUINT8 *)feature_data,(MUINT8 *)&s5kjn1sq03pd2219_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
				break;
			default:
...
static int s5kjn1sq03pd2219GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &s5kjn1sq03pd2219_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.get_sensor_tableinfo = s5kjn1sq03pd2219GetSensorTableInfo, //vivo lishuo add for otp remake 20210823 [B210917-2644]
};

UINT32 S5KJN1SQ03PD2219_MIPI_RAW_SensorInit(
