...
#define PFX "S5K4H7TD2203_camera_sensor"
...
#include "s5k4h7td2203mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7TD2203_SENSOR_ID,
...
kal_uint16 addr_data_pair_init_s5k4h7td2203[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
kal_uint16 addr_data_pair_preview_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom1_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom2_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom3_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom4_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom5_s5k4h7td2203[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7td2203,
                          sizeof(addr_data_pair_init_s5k4h7td2203) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7td2203,
                          sizeof(addr_data_pair_preview_s5k4h7td2203) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7td2203,
                          sizeof(addr_data_pair_capture_s5k4h7td2203) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7td2203,
                          sizeof(addr_data_pair_normal_video_s5k4h7td2203) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7td2203,
                          sizeof(addr_data_pair_hs_video_s5k4h7td2203) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7td2203,
                          sizeof(addr_data_pair_slim_video_s5k4h7td2203) / sizeof(kal_uint16));

}
static void custom1_setting(void)
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7td2203,
		   sizeof(addr_data_pair_custom1_s5k4h7td2203) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7td2203,
		   sizeof(addr_data_pair_custom2_s5k4h7td2203) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7td2203,
		   sizeof(addr_data_pair_custom3_s5k4h7td2203) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7td2203,
		   sizeof(addr_data_pair_custom4_s5k4h7td2203) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7td2203,
		   sizeof(addr_data_pair_custom5_s5k4h7td2203) / sizeof(kal_uint16));
	pr_debug("end \n");
}
/*************************************************************************
 * FUNCTION
...
UINT32 S5K4H7TD2203_MIPI_RAW_SensorInit(
