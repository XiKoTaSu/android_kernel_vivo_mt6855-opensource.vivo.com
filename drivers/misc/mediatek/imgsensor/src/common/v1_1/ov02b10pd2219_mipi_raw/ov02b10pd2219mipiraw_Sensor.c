...
#include "ov02b10pd2219mipiraw_Sensor.h"
#include "../imgsensor_i2c.h"


/*********************Modify Following Strings for Debug********************/
#define PFX "OV02B10PD2219_camera_sensor"
#define LOG_1 LOG_INF("OV02B10PD2219,MIPI 1LANE\n")
/***************************   Modify end    *******************************/
...
struct IMGSENSOR_SENSOR_TABLEINFO ov02b10pd2219_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA4,
        .OTP_size = 0x143F,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10PD2219_SENSOR_ID,
...
static kal_uint32 ov02b10pd2219_vivo_read_eeprom(kal_uint16 addr)
{
	kal_uint32 read_byte = 0;
	char pu_send_cmd[2] = {(char)(addr >> 8),  (char)(addr & 0xFF)};
    if (addr > ov02b10pd2219_sensortableinfo.sensorOtpInfo.Lsc_checksum_addr) { /*VIVO_MAX_OFFSET*/
		LOG_INF("exceed VIVO_MAX_OFFSET\n");
		return 255;
	}
	kdSetI2CSpeed((u16)imgsensor_info.i2c_speed);

	if (iReadRegI2C(pu_send_cmd,  2,  (u8 *)&read_byte,  1,  ov02b10pd2219_sensortableinfo.sensorOtpInfo.OTP_slave_addr) < 0) {
...
#else 
    return OV02B10PD2219_SENSOR_ID;
#endif
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		#if 1
			if(ov02b10pd2219_vivo_read_eeprom(0x15) == 0x00){
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	// 	switch (*feature_data) {
	// 		case 0:
	// 			//memcpy((MUINT8 *)feature_data,(MUINT8 *)&ov02b10pd2219_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
	// 			break;
	// 		default:
...
static int ov02b10pd2219GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &ov02b10pd2219_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
    .get_sensor_tableinfo = ov02b10pd2219GetSensorTableInfo,
};

UINT32 OV02B10PD2219_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10PD2219_MIPI_RAW_SensorInit      */
