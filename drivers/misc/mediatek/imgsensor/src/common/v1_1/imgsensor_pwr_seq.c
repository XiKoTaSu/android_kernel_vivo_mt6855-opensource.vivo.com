...
#if defined(CONFIG_MTK_CAM_TD2203)
#if defined(S5KJN1SQ03TD2203_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03TD2203_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 1},
...
#endif
#if defined(S5K4H7TD2203_MIPI_RAW)
{
	SENSOR_DRVNAME_S5K4H7TD2203_MIPI_RAW,
	{
		{RST, Vol_Low, 1},
		{SensorMCLK, Vol_High, 1},
		{AVDD, Vol_2800, 1},
...
#endif    
#if defined(OV02B10TD2203_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02B10TD2203_MIPI_RAW,
		{
			{RST, Vol_Low, 2},
			{DOVDD, Vol_1800, 2},
			{AVDD, Vol_2800, 5},
...
#endif    
#elif defined(CONFIG_MTK_CAM_PD2219)
#if defined(S5KJN1SQ03PD2219_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03PD2219_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 1},
...
#endif
#if defined(S5K4H7PD2219_MIPI_RAW)
{
	SENSOR_DRVNAME_S5K4H7PD2219_MIPI_RAW,
	{
		{RST, Vol_Low, 1},
		{SensorMCLK, Vol_High, 1},
		{AVDD, Vol_2800, 1},
...
#endif
#if defined(OV02B10PD2219_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02B10PD2219_MIPI_RAW,
		{
			{RST, Vol_Low, 2},
			{DOVDD, Vol_1800, 2},
			{AVDD, Vol_2800, 5},
...
#endif
#if defined(OV02B10V1PD2219_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02B10V1PD2219_MIPI_RAW,
		{
			{RST, Vol_Low, 2},
			{DOVDD, Vol_1800, 2},
			{AVDD, Vol_2800, 5},
...
#endif
#elif defined(CONFIG_MTK_CAM_PD2278)
#if defined(S5KJNSSQ33PD2278_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJNSSQ33PD2278_MIPI_RAW,
		{
			{I2C, Vol_High,1},
 			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 2},
			{DVDD, Vol_1000, 2},
			{AVDD1, Vol_2800, 1, Vol_Low, 15},
			{AVDD, Vol_2800, 7, Vol_Low, 1},
...
#endif
#if defined(S5K4H7PD2278_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7PD2278_MIPI_RAW,
		{
			{I2C, Vol_High,1},
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			...
			{DVDD, Vol_1200, 1},
			{DVDD1, Vol_1000, 1},
			{AVDD, Vol_2800, 1, Vol_Low, 9},
			{RST, Vol_High, 5}
		},
	},
#endif
#if defined(GC02M1BPD2278_MIPI_MONO)
	{
		SENSOR_DRVNAME_GC02M1BPD2278_MIPI_MONO,
		{
			{I2C, Vol_High,1},
			{RST, Vol_Low, 2},
			{DOVDD, Vol_1800, 4},
...
#endif
#endif
#if defined(S5KGW3SP13PD2214_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGW3SP13PD2214_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 1},
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 2},
			...
			{AVDD, Vol_2800, 5},
			{RST, Vol_High, 5},
			{AFVDD_DEF, Vol_3200, 2}
		},
	},
#endif
#if defined(S5KGD2SP03PD2214_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGD2SP03PD2214_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 2},
			{DVDD, Vol_1000, 2},
...
#endif
#if defined(GC02M1PD2214_MIPI_MONO)
	{
		SENSOR_DRVNAME_GC02M1PD2214_MIPI_MONO,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 2},
			{AVDD, Vol_2800, 7},
...
#endif
#if defined(GC02M1BPD2214_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1BPD2214_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 2},
			{AVDD, Vol_2800, 7},
