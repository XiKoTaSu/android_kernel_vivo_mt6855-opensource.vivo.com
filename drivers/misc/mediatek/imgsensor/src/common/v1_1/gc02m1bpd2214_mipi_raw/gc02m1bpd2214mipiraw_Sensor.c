...
#include "gc02m1bpd2214mipiraw_Sensor.h"
#include "../imgsensor_i2c.h"

#include "eeprom_driver.h"
#include "imgsensor_legacy.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1BPD2214_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BPD2214,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
struct IMGSENSOR_SENSOR_TABLEINFO gc02m1bpd2214_sensortableinfo={
	.sensorOtpInfo = {
...
static struct imgsensor_info_struct imgsensor_info = {
	/*.sensor_id = GC02M1BPD2214_SENSOR_ID, */
	.sensor_id = GC02M1BPD2214_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (tmp_id == GC02M1BPD2214_SENSOR_ID) {
...
*/
/*
static void vivo_read_eeprom3(void)
{
...
static kal_uint32 get_imgsensor_fuse_id(unsigned char *data)
{
	...
	unsigned char value=0,timeout=0;
	char temp_string[9];
	unsigned char material_inf_gc02mlbpd2214[4];
	unsigned char sn_inf_main_gc02m1bpd2214[13];
	if(data == NULL){
		return 0;
	}
	write_cmos_sensor(0xfc, 0x01);
	...
	write_cmos_sensor(0xf3, 0x34);
		...
		value =read_cmos_sensor(0x19);
		sn_inf_main_gc02m1bpd2214[j]= value;//read_cmos_sensor(0x19);
		LOG_INF("sn_inf read addr[%02x] = 0x%04x\n",i,sn_inf_main_gc02m1bpd2214[j]);
		timeout=0;
	}
	...
	write_cmos_sensor(0xf3, 0x34);
		...
		value =read_cmos_sensor(0x19);
		material_inf_gc02mlbpd2214[j]=value;//read_cmos_sensor(0x19);
		LOG_INF("material_inf read addr[%02x] = 0x%04x\n",i,material_inf_gc02mlbpd2214[j]);
		timeout=0;
	}
	sprintf(temp_string,"%02d%02d%02d%02d",material_inf_gc02mlbpd2214[0],material_inf_gc02mlbpd2214[1],material_inf_gc02mlbpd2214[2],material_inf_gc02mlbpd2214[3]);
    sprintf((char *)data,"%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X",
		sn_inf_main_gc02m1bpd2214[1],
		sn_inf_main_gc02m1bpd2214[2],
		sn_inf_main_gc02m1bpd2214[3],
		sn_inf_main_gc02m1bpd2214[4],
		sn_inf_main_gc02m1bpd2214[5],
		sn_inf_main_gc02m1bpd2214[6],
		sn_inf_main_gc02m1bpd2214[7],
		sn_inf_main_gc02m1bpd2214[8],
		sn_inf_main_gc02m1bpd2214[9],
		sn_inf_main_gc02m1bpd2214[10],
		sn_inf_main_gc02m1bpd2214[11],
		sn_inf_main_gc02m1bpd2214[12],
		temp_string[0],
		temp_string[1],
		temp_string[2],
		temp_string[3],
    ...
    LOG_INF("SN_inf = %s",data);
	return 0;
}

static int gc02m1bpd2214GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p)
{
    if(p != NULL){
        *p = &gc02m1bpd2214_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.get_sensor_tableinfo = gc02m1bpd2214GetSensorTableInfo,
};


UINT32 GC02M1BPD2214_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
