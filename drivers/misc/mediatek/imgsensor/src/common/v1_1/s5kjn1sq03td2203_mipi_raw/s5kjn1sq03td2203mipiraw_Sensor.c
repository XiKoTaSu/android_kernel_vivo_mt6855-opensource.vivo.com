...
#include "s5kjn1sq03td2203mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03TD2203_SENSOR_ID,
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		switch (*feature_data) {
			case 0:
				memcpy((MUINT8 *)feature_data,(MUINT8 *)&s5kjn1sq03td2203_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
				break;
			default:
...
UINT32 S5KJN1SQ03TD2203_MIPI_RAW_SensorInit(
