...
#include "ov02b10v1pd2219mipiraw_Sensor.h"
#include "../imgsensor_i2c.h"


/*********************Modify Following Strings for Debug********************/
#define PFX "OV02B10V1PD2219_camera_sensor"
#define LOG_1 LOG_INF("OV02B10V1PD2219,MIPI 1LANE\n")
/***************************   Modify end    *******************************/
...
struct IMGSENSOR_SENSOR_TABLEINFO ov02b10v1pd2219_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA4,
        .OTP_size = 0x143F,
    ...
    .sensorRawInfo = {
        ...
        .raw_height = 1200,
        .raw_dataBit = 2,
        .raw_colorFilterValue = BAYER_BGGR, //	BAYER_GRBG = 0, BAYER_GBRG = 1, BAYER_BGGR = 2, BAYER_RGGB = 3,
        .raw_blackLevel = 64,
        .raw_viewAngle = 81.6, //FOV
        .raw_bitWidth = 10,
        .raw_maxSensorGain = 16 //sensor gain
	}
};
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10V1PD2219_SENSOR_ID,
...
static kal_uint32 ov02b10v1pd2219_vivo_read_eeprom(kal_uint16 addr)
{
	kal_uint32 read_byte = 0;
	char pu_send_cmd[2] = {(char)(addr >> 8),  (char)(addr & 0xFF)};
    if (addr > ov02b10v1pd2219_sensortableinfo.sensorOtpInfo.Lsc_checksum_addr) { /*VIVO_MAX_OFFSET*/
		LOG_INF("exceed VIVO_MAX_OFFSET\n");
		return 255;
	}
	kdSetI2CSpeed((u16)imgsensor_info.i2c_speed);

	if (iReadRegI2C(pu_send_cmd,  2,  (u8 *)&read_byte,  1,  ov02b10v1pd2219_sensortableinfo.sensorOtpInfo.OTP_slave_addr) < 0) {
		LOG_INF("value is invalid\n");
		return 255;
	}
	LOG_INF("read byte:0x%x\n",read_byte);
    return read_byte;
}
...
#else
    return OV02B10V1PD2219_SENSOR_ID;
#endif
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		#if 1
			if(ov02b10v1pd2219_vivo_read_eeprom(0x15) == 0x01){

				if (*sensor_id == imgsensor_info.sensor_id) {

					LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n",
						imgsensor.i2c_write_id, *sensor_id);
					ov02b10v1pd2219_sensortableinfo.sensorOtpInfo.AWBforceGainSetNum = 1; // 2371273 only has 5100K
					return ERROR_NONE;
				}
			}else{
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	// 	switch (*feature_data) {
	// 		case 0:
	// 			//memcpy((MUINT8 *)feature_data,(MUINT8 *)&ov02b10v1pd2219_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
	// 			break;
	// 		default:
...
static int ov02b10v1pd2219GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &ov02b10v1pd2219_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
    .get_sensor_tableinfo = ov02b10v1pd2219GetSensorTableInfo,
};

UINT32 OV02B10V1PD2219_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10V1PD2219_MIPI_RAW_SensorInit      */
