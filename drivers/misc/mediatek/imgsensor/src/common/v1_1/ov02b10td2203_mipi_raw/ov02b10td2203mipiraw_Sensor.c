...
#include "ov02b10td2203mipiraw_Sensor.h"
#include "../imgsensor_i2c.h"


/*********************Modify Following Strings for Debug********************/
#define PFX "OV02B10TD2203_camera_sensor"
#define LOG_1 LOG_INF("OV02B10TD2203,MIPI 1LANE\n")
/***************************   Modify end    *******************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10TD2203_SENSOR_ID,
...
#else 
    return OV02B10TD2203_SENSOR_ID;
#endif
}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	// 	switch (*feature_data) {
	// 		case 0:    
	// 			//memcpy((MUINT8 *)feature_data,(MUINT8 *)&ov02b10td2203_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
	// 			break;
	// 		default:
...
UINT32 OV02B10TD2203_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10TD2203_MIPI_RAW_SensorInit      */
