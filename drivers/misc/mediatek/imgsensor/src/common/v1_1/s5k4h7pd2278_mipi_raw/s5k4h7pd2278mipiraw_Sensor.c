...
#define PFX "S5K4H7PD2278_camera_sensor"
...
#include "s5k4h7pd2278mipiraw_Sensor.h"
...
struct IMGSENSOR_SENSOR_TABLEINFO s5k4h7pd2278_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA2,
        .OTP_size = 0x0F31,
    ...
    .sensorRawInfo = {
        ...
        .raw_height = 2448,
        .raw_dataBit = 2,
        .raw_colorFilterValue = BAYER_GBRG, //	BAYER_GRBG = 0, BAYER_GBRG = 1, BAYER_BGGR = 2, BAYER_RGGB = 3,
        .raw_blackLevel = 64,
        .raw_viewAngle = 82.7, //FOV
        .raw_bitWidth = 10,
        .raw_maxSensorGain = 16 //sensor gain
	}
};

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7PD2278_SENSOR_ID,
	...
	.min_shutter = 4,
	.min_gain = 64,
	.max_gain = 1024,//mode  gain different (64x64) 16x gain
	.min_gain_iso = 100,
	.gain_step = 2,
	.gain_type = 2,
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
  ...
  switch (image_mirror)
    ...
    case IMAGE_V_MIRROR: //Gr X
      write_cmos_sensor_16_8(0x0101, 0x02);	//Set flip
      break;
    case IMAGE_H_MIRROR: //Gb
      write_cmos_sensor_16_8(0x0101, 0x01);	//Set mirror
      break;
...
kal_uint16 addr_data_pair_init_s5k4h7pd2278[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
kal_uint16 addr_data_pair_preview_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom1_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom2_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom3_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom4_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom5_s5k4h7pd2278[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7pd2278,
                          sizeof(addr_data_pair_init_s5k4h7pd2278) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7pd2278,
                          sizeof(addr_data_pair_preview_s5k4h7pd2278) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7pd2278,
                          sizeof(addr_data_pair_capture_s5k4h7pd2278) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7pd2278,
                          sizeof(addr_data_pair_normal_video_s5k4h7pd2278) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7pd2278,
                          sizeof(addr_data_pair_hs_video_s5k4h7pd2278) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7pd2278,
                          sizeof(addr_data_pair_slim_video_s5k4h7pd2278) / sizeof(kal_uint16));

}
static void custom1_setting(void)
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7pd2278,
		   sizeof(addr_data_pair_custom1_s5k4h7pd2278) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7pd2278,
		   sizeof(addr_data_pair_custom2_s5k4h7pd2278) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7pd2278,
		   sizeof(addr_data_pair_custom3_s5k4h7pd2278) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7pd2278,
		   sizeof(addr_data_pair_custom4_s5k4h7pd2278) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7pd2278,
		   sizeof(addr_data_pair_custom5_s5k4h7pd2278) / sizeof(kal_uint16));
	pr_debug("end \n");
}
/*************************************************************************
 * FUNCTION
...
//vivo lishuo add for otp remake 20210823 [B210917-2644] begin
...
static int s5k4h7pd2278GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &s5k4h7pd2278_sensortableinfo;
        get_imgsensor_fuse_id((**p).sensorOtpInfo.Fuse_id);
    }
    return 0;
}
//vivo lishuo add for otp remake 20210823 [B210917-2644] end
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
    .get_sensor_tableinfo = s5k4h7pd2278GetSensorTableInfo,
};

UINT32 S5K4H7PD2278_MIPI_RAW_SensorInit(
