...
#include "gc02m1pd2214mipimono_Sensor.h"
#include "../imgsensor_i2c.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1PD2214_camera_sensor"
#define LOG_1 LOG_INF("GC02M1PD2214,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)

struct IMGSENSOR_SENSOR_TABLEINFO gc02m1pd2214_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA4,
        .OTP_size = 0x143F,
    ...
    .sensorRawInfo = {
        ...
        .raw_height = 1200,
        .raw_dataBit = 2,
        .raw_colorFilterValue = BAYER_RGGB, //	BAYER_GRBG = 0, BAYER_GBRG = 1, BAYER_BGGR = 2, BAYER_RGGB = 3,
        .raw_blackLevel = 64,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1PD2214_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (tmp_id == GC02M1PD2214_SENSOR_ID) {
...
static int gc02m1pd2214GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &gc02m1pd2214_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.get_sensor_tableinfo = gc02m1pd2214GetSensorTableInfo,
};


UINT32 GC02M1PD2214_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
