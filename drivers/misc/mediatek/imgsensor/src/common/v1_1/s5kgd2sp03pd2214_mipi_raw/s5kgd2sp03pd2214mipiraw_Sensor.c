 ...
 * Filename:
 * ---------
 *	 s5kgd2sp03pd2214mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgd2sp03pd2214mipiraw_Sensor.h"
#include "../imgsensor_common.h"

#include "s5kgd2sp03pd2214mipiraw_freq.h"
...
struct IMGSENSOR_SENSOR_TABLEINFO s5kgd2sp0313pd2214_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA2,
        .OTP_size = 0x143F,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGD2SP03PD2214_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 6528, 4896,	0,612,  6528, 3672, 3264, 1836,	0000, 0000,	3264, 1836,	  0,	0, 	3264, 1836}, /*hight speed video 60fps*/
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_16_16(0x001E, 0x0300);
	write_cmos_sensor_16_16(0x6028, 0x4000);
...
static kal_uint32 get_sensor_temperature(void)
{
	...
	if (TMC_000A_Value >0x0000 && TMC_000A_Value<0x5600){
	  	/*PK_DBG("GD2 TMC is available \n");*/
	}
	else{
		 PK_DBG("GD2 TMC is not available, the sensor is not calibration \n");
	}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6356000;
		break;
...
static int s5kgd2sp03pd2214GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &s5kgd2sp0313pd2214_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.get_sensor_tableinfo = s5kgd2sp03pd2214GetSensorTableInfo,
};

UINT32 S5KGD2SP03PD2214_MIPI_RAW_SensorInit(
