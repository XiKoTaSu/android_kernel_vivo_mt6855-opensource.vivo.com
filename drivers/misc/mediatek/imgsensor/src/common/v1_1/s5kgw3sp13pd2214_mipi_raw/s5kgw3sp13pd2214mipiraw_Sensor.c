 ...
 * Filename:
 * ---------
 *	 s5kgw3sp13pd2214mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgw3sp13pd2214mipiraw_Sensor.h"
#include "../imgsensor_common.h"

#include "s5kgw3sp13pd2214mipiraw_freq.h"
...
struct IMGSENSOR_SENSOR_TABLEINFO s5kgw3sp13pd2214_sensortableinfo={
    .sensorOtpInfo = {
        .OTP_slave_addr = 0xA4,
        .OTP_size = 0x3034,
        .OTP_addr_offset = 0x5000,
        ...
        .Awb_checksum_addr = 0x00C1,
        .Lsc_addr = 0x00C2,
        .Lsc_checksum_addr = 0x081F,
        .PDAF_proc1_addr = 0x0820,
        .PDAF_proc1_checksum_addr = 0x0A20,
        .PDAF_proc2_addr = 0x0A21,
        .PDAF_proc2_checksum_addr = 0x0E18,

        .XTC_cal_addr = 0x1A39,
        .XTC_cal_checksum_addr = 0x246E,
        .SensorXTC_cal_addr = 0x246F,
        .SensorXTC_cal_checksum_addr = 0x2530,
        .PDXTC_addr = 0x2531,
        .PDXTC_checksum_addr = 0x2C84,
        .SW_GGC_addr = 0x2C85,
        .SW_GGC_checksum_addr = 0x2E48
    },
    .sensorRawInfo = {
        .raw_weight = 4608,
        .raw_height = 3456,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGW3SP13PD2214_SENSOR_ID,
...
//	{9216, 6912,  768, 1296, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080}, /* slim video */
	...
	{9216, 6912,  576,  432, 8064, 6048, 4032, 3024, 0, 0, 4032, 3024, 0, 0, 4032, 3024}, /* custom1 */
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =  //4640*3456
{
	...
	.i4BlockNumY = 432,
	.iMirrorFlip = 3,
	.i4Crop = { {16,8}, {16,8}, {16, 440}, {0, 0}, {0, 0}, {304,224}, {400, 656}, {400, 656}, {16, 440}, {0, 0}},
};
...
{
#ifdef CONFIG_MTK_CAM_PD2214F_EX
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
 	//unsigned char material_inf_s5kgw3sp13pd2214[4] ={0,0,0,0};
	//int offset = 0x500F;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		for(j = 0;j < 4;j++)
		{
			s5kgw3sp13pd2214_vivo_read_eeprom(offset,&material_inf_s5kgw3sp13pd2214[j]);
			PK_DBG("vivo_material_inf_s5kgw3sp13pd2214[%d]=0x%x",j,material_inf_s5kgw3sp13pd2214[j] );
			offset++;
		}
		PK_DBG("i2c write id: 0x%x, sensor id: 0x%x material_inf_s5kgw3sp13pd2214=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_s5kgw3sp13pd2214[0]<<24|(unsigned int)material_inf_s5kgw3sp13pd2214[1]<<16|(unsigned int)material_inf_s5kgw3sp13pd2214[2]<<8|(unsigned int)material_inf_s5kgw3sp13pd2214[3]));
				if((unsigned int)material_inf_s5kgw3sp13pd2214[3] == 0x96)
				{
					if (*sensor_id == imgsensor_info.sensor_id)
					{
					PK_DBG("i2c write id: 0x%x, sensor id: 0x%x material_inf_s5kgw3sp13pd2214=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_s5kgw3sp13pd2214[0]<<24|(unsigned int)material_inf_s5kgw3sp13pd2214[1]<<16|(unsigned int)material_inf_s5kgw3sp13pd2214[2]<<8|(unsigned int)material_inf_s5kgw3sp13pd2214[3]));
        				vivo_s5kgw3sp13pd2214_otp_read_when_power_on = s5kgw3sp13pd2214_otp_read();
        				pr_debug("read eeprom ---vivo_MAIN_7309_otp_read_when_power_on = %d,S5KGW3SP13PD2214_OTP_ERROR_CODE =%d\n", vivo_s5kgw3sp13pd2214_otp_read_when_power_on, S5KGW3SP13PD2214_OTP_ERROR_CODE);
        				return ERROR_NONE;
					}
			    }else	{
                                pr_err("material_inf_s5kgw3sp13pd2214[3]=0x%x != 0x96",material_inf_s5kgw3sp13pd2214[3] );
                                *sensor_id = 0xFFFFFFFF;
                                return ERROR_SENSOR_CONNECT_FAIL;
                        }
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				pr_debug("start read eeprom ---vivo_otp_read_when_power_on = %d\n", vivo_s5kgw3sp13pd2214_otp_read_when_power_on);
				vivo_s5kgw3sp13pd2214_otp_read_when_power_on = s5kgw3sp13pd2214_otp_read();
				pr_debug("read eeprom ---vivo_MAIN_7309_otp_read_when_power_on = %d,MAIN_7309_OTP_ERROR_CODE=%d\n", vivo_s5kgw3sp13pd2214_otp_read_when_power_on, S5KGW3SP13PD2214_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
#endif
...
static int s5kgw3sp13pd2214GetSensorTableInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p){
    if(p != NULL){
        *p = &s5kgw3sp13pd2214_sensortableinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.get_sensor_tableinfo = s5kgw3sp13pd2214GetSensorTableInfo,
};

UINT32 S5KGW3SP13PD2214_MIPI_RAW_SensorInit(
