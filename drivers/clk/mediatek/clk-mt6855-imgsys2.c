...
#define GATE_IMGSYS2_DUMMYS(_id, _name, _parent, _shift) {	\
		.id = _id,				\
		.name = _name,				\
		.parent_name = _parent,			\
		.regs = &imgsys2_cg_regs,			\
...
static const struct mtk_gate imgsys2_clks[] = {
	GATE_IMGSYS2_DUMMYS(CLK_IMGSYS2_LARB9, "imgsys2_larb9_1",
			"img1_ck"/* parent */, 0),
	GATE_IMGSYS2(CLK_IMGSYS2_LARB9_1, "imgsys2_larb9",
		"img1_ck"/* parent */, 0),
