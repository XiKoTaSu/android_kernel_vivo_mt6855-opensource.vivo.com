...
#define GATE_IMGSYS1_DUMMYS(_id, _name, _parent, _shift) {	\
		.id = _id,				\
		.name = _name,				\
		.parent_name = _parent,			\
		.regs = &imgsys1_cg_regs,			\
...
static const struct mtk_gate imgsys1_clks[] = {
	GATE_IMGSYS1_DUMMYS(CLK_IMGSYS1_LARB9, "imgsys1_larb9_1",
			"img1_ck"/* parent */, 0),
	GATE_IMGSYS1(CLK_IMGSYS1_LARB9_1, "imgsys1_larb9",
			"img1_ck"/* parent */, 0),
