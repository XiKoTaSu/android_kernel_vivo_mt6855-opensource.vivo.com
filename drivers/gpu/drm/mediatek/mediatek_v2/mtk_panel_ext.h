...
struct mtk_panel_funcs {
	 ...
	 * @lcm_pre_prepare:
	 *
	 * for lcm power init before mipi LP11.
	 */
	int (*lcm_pre_prepare)(struct drm_panel *panel);
	/**
	 * @lcm_post_unprepare:
	 *
	 * for lcm power deinit after mipi disable.
	 */
	int (*lcm_post_unprepare)(struct drm_panel *panel);
